    ...
    return (
        <div>
            ...
            <p className='p-popup-warn-create-ann'>
                ...
                <br/><br/>
                Al día puedes publicar un total de 3 anuncios, y puedes tener un maximo de 10 anuncios gratuitos al mismo tiempo, todo esto lo explicamos mas a detalle en nuestras <a href='/condiciones' target='_blank'>Condiciones de uso</a>, tambien te invitamos a leer nuestras <a href='/politicas' target='_blank'>Politicas de privacidad</a>.
                <br/><br/>
