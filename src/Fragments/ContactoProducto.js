...
const ContactoProducto = ({callBack, handleBack, formData, setFormData}) => {
            ...
            <ContentLayout horizontalAlign='center'>
                <div className='form-create-ann'>
                    ...
                    <section className='section-double-input'>
                        <Checkbox
                            id='Entrega en punto medio'
                            label='Entrega en punto medio'
                            value='Entrega en punto medio'
                            onChange={handleCheck}
                        />

                        <section style={{ width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
                            <Checkbox
                                id='Entrega en puntos especificos'
                                label={<>Entrega en puntos especificos<span className='required'>*</span></>}
                                value='Entrega en puntos especificos'
                                onChange={handleCheck}
                            />
                            {
                                formasEntrega.findIndex(item => item['forma'] === 'Entrega en puntos especificos') > -1
                                    ?   <Input
                                            label='¿Cuales son los puntos especificos?'
                                            placeholder='Ej. Centros comerciales, estaciones del metro, centro'
                                            id={'Entrega en puntos especificos-input'}
                    ...
                    <section className='section-double-input'>
                        ...
                        <Checkbox
                            id='Entrega a domicilio (con cargo adicional)'
                            label='Entrega a domicilio (con cargo adicional)'
                            value='Entrega a domicilio (con cargo adicional)'
                            onChange={handleCheck}
                        />
                    </section> 
                    ...
                    <section className='section-double-input'>
                        <Checkbox
                            id='Entrega por paqueteria'
                            label='Entrega por paqueteria'
                            value='Entrega por paqueteria'
                            onChange={handleCheck}
                        />

                        <Checkbox
                            id='Entrega por paqueteria (con cargo adicional)'
                            label='Entrega por paqueteria (con cargo adicional)'
                            value='Entrega por paqueteria (con cargo adicional)'
                            onChange={handleCheck}
                        />
                    </section>    
